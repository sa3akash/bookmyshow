class MetricsRegistry {
  ...
  getHttpRequestsTotal(): number { return this.httpRequestsTotal; }
  getBookingAttemptsTotal(): number { return this.bookingAttemptsTotal; }
  getBookingSuccessTotal(): number { return this.bookingSuccessTotal; }
  getSeatLockTotal(): number { return this.seatLockTotal; }
  getPaymentSuccessTotal(): number { return this.paymentSuccessTotal; }
