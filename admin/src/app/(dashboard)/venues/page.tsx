...
import { Building2, Plus, MapPin, Phone, Layers, Edit, Trash2, RefreshCw, Filter, CheckCircle2, X } from "lucide-react";
...
import { useVenuesQuery, useCitiesQuery, useCreateVenueMutation, useCreateCityMutation, VenueRecord } from "@/hooks/useAdminQueries";
...
export default function VenuesPage() {
  ...
  // Sync selectedCityId when citiesList loads
  React.useEffect(() => {
